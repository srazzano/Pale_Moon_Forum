...
Start by clicking on "View All Boards" button to view all boards and select desired boards to open/close.<br>Then click on "Hide Unchecked Boards" button to hide the unchecked boards. Will retain selected boards on page reload.
